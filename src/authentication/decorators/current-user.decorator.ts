// src/authentication/decorators/current-user.decorator.ts
// Estado: ✅ MANTENER

// Razones:

// Es un decorador útil y bien implementado
// Aunque no se usa actualmente en los controllers (porque el guard ya valida), sí se usa internamente en otros lugares
// Es una utilidad común que probablemente necesitarás en el futuro

// Casos de uso futuros:

// // Cuando necesites el usuario en un endpoint sin guard
// @Get('me')
// getProfile(@CurrentUser() user: UserPayload) {
//   return this.userService.findOne(user.id);
// }

// // Cuando necesites solo una propiedad
// @Get('my-email')
// getMyEmail(@CurrentUser('email') email: string) {
//   return { email };
// }

// Recomendación: ✅ Déjalo en el commit
