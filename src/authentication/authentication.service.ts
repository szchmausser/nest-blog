// Autenticacion 7.2
// * `validateUser`: Verifica email y password (con bcrypt).
// * `login`: Genera el token con `this.jwtService.sign(payload)`.
...
export class AuthenticationService {
  ...
  async register(registerDto: RegisterDto) {
    ...
    // UserService.create ya retorna el usuario sin la contraseña.
