// Autenticacion 3.1
// JwtStrategy - Esta clase es buscada por `AuthGuard('jwt')` en tiempo de ejecución.

import { Injectable } from '@nestjs/common';
import { PassportStrategy } from '@nestjs/passport';
import { ExtractJwt, Strategy } from 'passport-jwt';
import { Request } from 'express';
import { AUTH_COOKIE_NAME } from '../../authentication/constants/authentication.constants';
