// Autenticacion 7.1
// Con la seguridad configurada, implementamos cómo obtener el token.
// * Endpoint `POST /auth/login`.
// * `@Public()`: ¡Importante! Porque el guard global está activo, necesitamos abrir esta puerta para poder entrar.
import {
  Body,
  Controller,
  Post,
